...
!function(c) {
  ...
  if (c.support.touch = "ontouchend" in document, c.support.touch) {
    var e, d = c.ui.mouse.prototype, f = d._mouseInit, g = d._mouseDestroy;
    ...
    d._mouseInit = function() {
      this.element.bind({touchstart:c.proxy(this, "_touchStart"), touchmove:c.proxy(this, "_touchMove"), touchend:c.proxy(this, "_touchEnd")});
      f.call(this);
    };
    d._mouseDestroy = function() {
      this.element.unbind({touchstart:c.proxy(this, "_touchStart"), touchmove:c.proxy(this, "_touchMove"), touchend:c.proxy(this, "_touchEnd")});
      g.call(this);
    };
  }
}(jQuery);
