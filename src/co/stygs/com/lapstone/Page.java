...
public class Page {
	public static Boolean PageLapstone(Map<String, String> argMap) {
		...
		try {
			...
			File newJs = new File(www_debug, "js/page/page."
					+ argMap.get("name") + ".js");
			File newHtml = new File(www_debug, "page/" + argMap.get("name")
					+ ".html");
			File newJson = new File(www_debug, "js/page/page."
					+ argMap.get("name") + ".json");

			String json;

			json = FileUtils.readFileToString(templateJson);
