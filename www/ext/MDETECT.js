...
var MobileEsp = {
	...
	isTierGenericMobile : false, // Stores the result of
	...
	engineSilk : 'silk-accelerated', // Amazon's accelerated Silk browser for
										// Kindle Fire
	...
	mobile : 'mobile', // Some mobile browsers put 'mobile' in their user agent
						// strings
	mobi : 'mobi', // Some mobile browsers put 'mobi' in their user agent
					// strings
	...
	// Google says these devices will have 'Android' and NOT 'mobile' in their
	// user agent.
	...
	DetectBlackBerryLow : function() {
		if (this.DetectBlackBerry()) {
			// Assume that if it's not in the High tier or has WebKit, then it's
			// Low.
	...
	DetectSymbianOS : function() {
		if (this.uagent.search(this.deviceSymbian) > -1 || this.uagent.search(this.deviceS60) > -1 || ((this.uagent.search(this.deviceSymbos) > -1) && (this.DetectOperaMobile)) || // Opera
																																													// 10
	...
	// Note: Older embedded Opera on mobile devices didn't follow these naming
	// conventions.
	// Like Archos media players, they will probably show up in
	// DetectMobileQuick or -Long instead.
	...
	// **************************
	// Detects if the current Amazon device has turned on the Silk accelerated
	// browsing feature.
	...
	// a touchscreen and modern iPhone-class browser. Includes the Playstation
	// Vita.
	...
	// Note: It's better to use DetectTierIphone() for modern touchscreen
	// devices.
	...
	// Includes iPhone, iPod Touch, Android, Windows Phone 7 and 8, BB10, WebOS,
	...
	DetectTierRichCss : function() {
		...
		// If it's a mobile webkit browser on any other device, it's probably
		// OK.
		if (this.DetectWebkit())
			return true;
